...
from dmarc_report_aggregator.models import DmarcReport, DmarcRecord, DmarcPolicy, DkimResult, SpfResult
...
def _parse_record(element: Element) -> DmarcRecord:
    return DmarcRecord.model_validate({
        ...
        "disposition": _findtext_required(element, "row/policy_evaluated/disposition"),
        ...
        "dkim_results": [_parse_dkim_result(e) for e in element.iterfind("auth_results/dkim")],
        "spf_results": [_parse_spf_result(e) for e in element.iterfind("auth_results/spf")]
    })
